...
import {Button, CustomPhoneInput, IconButton, Input, Spinner,} from "../../components";
...
const Login = () => {
    ...
    const {loading: initLoading, fetchAllInitialInfo} = useInit();
    ...
    const handleEmailLogin = async () => {
        try {
            ...
            if (response.ok) {
                ...
                setAuthToken(token as string);
                dispatch(setAuth({token, user}));
                toast.success("Welcome to the back !!!");
                await fetchAllInitialInfo();
                navigate("/dashboard");
            } else {
                toast.error(response.message);
            }
